...
(defun my-org-mode-auto-fill ()
  "Enable auto-fill in Org mode and set fill column."
  (auto-fill-mode 1)                ;; Enable auto-fill mode
  (set-fill-column 70)              ;; Set the fill column to 70 characters
  (message "Auto Fill Mode enabled with fill-column set to %d" fill-column))

(add-hook 'org-mode-hook 'my-org-mode-auto-fill)
