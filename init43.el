...
(defun roy/elfeed-load-db-and-open ()
...
(defun roy/elfeed-save-db-and-bury ()
...
(setq elfeed-db-directory "~/Sync/3_resources/elfeed/elfeeddb")

(use-package elfeed-org
  :ensure t
  :config
  (elfeed-org)
  (setq rmh-elfeed-org-files (list "~/Sync/3_resources/elfeed/elfeed_org/elfeed.org")))
...
;; 	"https://https://planet.emacslife.com/atom.xml"))
