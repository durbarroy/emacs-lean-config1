...
#+begin_src emacs-lisp
  ...
  (setq org-capture-templates
       '(("t" "Todo" entry (file+headline "~/Sync/my_multiverse/notes/org_capture_and_agenda1/capture.org" "Tasks")
          "* TODO %^{Title} :%^{Tags}:\n%U%i\n%?\n")
         ("c" "Capture anything" entry (file+olp+datetree "~/Sync/my_multiverse/notes/org_capture_and_agenda1/capture.org")
          "* %^{Title} :%^{Tags}:\n%U%i\n%?\n")
         ))
#+end_src
